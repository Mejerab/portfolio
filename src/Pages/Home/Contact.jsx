...
import { FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaNetworkWired } from "react-icons/fa";
import { Link } from "react-router";
import { IoCode } from "react-icons/io5";

const Contact = () => {
    return (
        <section id="contact" className="relative w-full bg-linear-to-br from-[#FF31456B] via-[#52A3FF2E] to-[#050812] via-40% to-75% lg:h-173 rounded-[52px] border-[#FFFFFF33] border overflow-hidden">
            <div>
            ...
            <div className="relative p-8 lg:p-16 flex lg:flex-row flex-col items-center justify-between gap-16">
                ...
                <div className="relative lg:w-fit lg:w-2/3 overflow-hidden grow rounded-4xl bg-linear-to-b from-[#070A13D1] from-70% to-[#52A3FF1F]">
                    ...
                    <div className="flex flex-col items-center p-6 py-8 space-y-4">
                        ...
                        <BtnHook text={'Email Me'} link={'mailto:omim3670@gmail.com'} full mail/>
                        <BtnHook text={'Github'} link={'https://github.com/Mejerab'} full git blue/>
                        <BtnHook text={'Download Resume'} link="/Resume-Meherab.pdf" download full no/>
                        <div className="flex items-center gap-x-3">
                            <div className="w-10 h-10 group rounded-full flex items-center cursor-pointer justify-center text-xl blue bg-[#52A3FF33]"><Link target="_blank" to={'https://www.linkedin.com/in/meherab-hossean-omi-430868329/'}><FaLinkedin className="group-hover:scale-125 tra" /></Link></div>
                            <div className="w-10 h-10 group rounded-full flex items-center cursor-pointer justify-center text-xl spidy bg-[#FF314533]"><Link target="_blank" to={'https://www.facebook.com/profile.php?id=100092038001931'}><FaFacebook className="group-hover:scale-125 tra" /></Link></div>
                            <div className="w-10 h-10 group rounded-full flex items-center cursor-pointer justify-center text-xl blue bg-[#52A3FF33]"><Link target="_blank" to={'https://github.com/Mejerab'}><FaGithub className="group-hover:scale-125 tra" /></Link></div>
                            <div className="w-10 h-10 group rounded-full flex items-center cursor-pointer justify-center text-xl spidy bg-[#FF314533]"><Link target="_blank" to={'https://www.instagram.com/mejerabxd/'}><FaInstagram className="group-hover:scale-125 tra" /></Link></div>
                        </div>
                    </div>
                </div>
            </div>
