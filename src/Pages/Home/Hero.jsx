        ...
        <div className="flex lg:flex-row flex-col items-start justify-between gap-12 lg:gap-5 -mt-8">
            <div className="space-y-5 lg:w-1/2">
                ...
                <TextType
                    ...
                    typingSpeed={75}
                    pauseDuration={1500}
                    className="teko font-bold text-5xl lg:text-7xl leading-15 lg:leading-20 lg:h-80"
                />
            ...
            <div className="lg:block hidden bg-linear-to-br from-0% via-[#070A13] to-[#E11D2E66] border-[#52A3FF38] space-y-3 border rounded-4xl w-136.75 p-5 py-7 lg:mx-0 mx-auto">
