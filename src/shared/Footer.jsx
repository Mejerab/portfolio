...
const Footer = () => {
    return (
        <div className="w-full lg:h-28 bg-linear-to-r from-[#E11D2E2F] from-0% via-[#070A1333] to-[#52A3FF2F] rounded-4xl border border-t-[#FF3145] border-l-[#FF3145] border-[#52A3FF] p-6 items-center justify-center lg:justify-between grid gap-y-12 lg:grid-cols-3 relative">
            ...
            <div className="lg:flex mx-auto">
                <ul className="text-[13px] flex items-center gap-x-4 font-bold">
                    ...
                    <li className="hovSpidy relative transition-colors group"><NavLink hrefLang="#navbar" to='/works'>Projects</NavLink><div className="group-hover:w-full absolute -bottom-0.5 rounded-lg duration-200 left-0 w-0 h-0.5 bgSpidy"></div></li>
